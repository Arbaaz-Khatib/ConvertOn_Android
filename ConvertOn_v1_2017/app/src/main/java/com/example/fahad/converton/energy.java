...
public class energy extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private void fillSpinnerWithEnergyUnit(){
        ...
        unitarrayadapter.add(getResources().getString(R.string.energyunitkilojoules));
