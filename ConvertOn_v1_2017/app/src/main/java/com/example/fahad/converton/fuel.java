...
public class fuel extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentStrategy = new FuelStrategy();
        instance = this;
    }
    ...
    private void fillSpinnerWithFuelUnit(){
        ...
        unitarrayadapter.add(getResources().getString(R.string.fuelunitmpg));
        unitarrayadapter.add(getResources().getString(R.string.fuelunitmpl));
        unitarrayadapter.add(getResources().getString(R.string.fuelunitkml));
        unitarrayadapter.add(getResources().getString(R.string.fuelunitlpk));
