...
public class angle extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentStrategy = new AngleStrategy();
        instance = this;
    }
    ...
    private void fillSpinnerWithAngleUnit(){
        ...
        unitarrayadapter.add(getResources().getString(R.string.angleunitd));
        unitarrayadapter.add(getResources().getString(R.string.angleunitr));
        unitarrayadapter.add(getResources().getString(R.string.angleunitg));
