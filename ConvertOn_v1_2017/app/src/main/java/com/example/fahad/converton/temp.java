...
public class temp extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    private void fillSpinnerWithTempUnit() {
        ...
        unitarrayadapter.add(getResources().getString(R.string.temperatureunitk));
