...
public class data extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentStrategy = new DataStrategy();
        instance = this;
    }
    ...
    private void fillSpinnerWithDataUnit(){
        ...
        unitarrayadapter.add(getResources().getString(R.string.dataunitb));
        unitarrayadapter.add(getResources().getString(R.string.dataunitby));
        unitarrayadapter.add(getResources().getString(R.string.dataunitkb));
        unitarrayadapter.add(getResources().getString(R.string.dataunitmb));
        unitarrayadapter.add(getResources().getString(R.string.dataunitgb));
        unitarrayadapter.add(getResources().getString(R.string.dataunittb));
