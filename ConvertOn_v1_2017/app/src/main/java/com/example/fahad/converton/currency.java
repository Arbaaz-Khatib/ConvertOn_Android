...
public class currency extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentStrategy = new CurrencyStrategy();
        instance = this;
    }
    ...
    private void fillSpinnerWithCurrencyUnit() {
        ...
        unitarrayadapter.add(getResources().getString(R.string.currencyuniti));
        unitarrayadapter.add(getResources().getString(R.string.currencyunitd));
        unitarrayadapter.add(getResources().getString(R.string.currencyunitp));
        unitarrayadapter.add(getResources().getString(R.string.currencyunite));
        unitarrayadapter.add(getResources().getString(R.string.currencyunitdi));
