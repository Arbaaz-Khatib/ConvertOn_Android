...
public class cooking extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentStrategy = new CookStrategy();
        instance = this;
    }


    private void fillSpinnerWithCookUnit() {
        unitarrayadapter.clear();
        unitarrayadapter.add(getResources().getString(R.string.cookunitc));
        unitarrayadapter.add(getResources().getString(R.string.cookunitt));
        unitarrayadapter.add(getResources().getString(R.string.cookunitta));
